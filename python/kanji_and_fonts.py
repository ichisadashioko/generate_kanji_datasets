# this script acts as config file

# list of characters to be drew
KANJI_LIST = [
...
# where the 'ttf' and 'otf' files is stored
FONT_DIRS = ['../truetype_fonts', '../opentype_fonts']

# the sizes of character (proportional with the image)
FONT_RATIOS = [0.6, 0.75, 0.9]